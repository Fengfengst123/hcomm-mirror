...
- [HcclChannelConfig](HcclChannelConfig.md)
- [HcclChannelConfigType](HcclChannelConfigType.md)
- [HcommResult](HcommResult.md)
- [HcommMemHandle](HcommMemHandle.md)
- [HcommSocket](HcommSocket.md)
...
- [HcclTeamCreateDesc](HcclTeamCreateDesc.md)
- [HcommTeamHandle](HcommTeamHandle.md)
- [HcommTeamSyncMemRequirement](HcommTeamSyncMemRequirement.md)
- [CcuResult](CcuResult.md)
- [CcuInsHandle](CcuInsHandle.md)
- [CcuKernelHandle](CcuKernelHandle.md)
- [CcuVariableHandle](CcuVariableHandle.md)
- [CcuAddressHandle](CcuAddressHandle.md)
- [CcuEventHandle](CcuEventHandle.md)
- [CcuBufferHandle](CcuBufferHandle.md)

...
#pragma pack(push, 1)
        ...
        struct CcuInstrWait {
            uint16_t conditionXnId; // Xn
            uint16_t expectedXnId;  // Xm
            uint16_t conditionType : 4;
            uint16_t reserved : 12;
...
#pragma pack(pop)
    ...
    void
    LoopGroupInstr(CcuInstr* instr, uint16_t startLoopInstrId, uint16_t xnId, uint16_t xmId, uint16_t highPerfModeEn);
    ...
    void TransLocMSToRmtMSInstr(
        CcuInstr* instr, uint16_t rmtMSId, uint16_t locMSId, uint16_t lengthXnId, uint16_t channelId,
        uint16_t setRmtCKEId, uint16_t setRmtCKEMask, uint16_t setCKEId, uint16_t setCKEMask, uint16_t waitCKEId,
    ...
    void SyncCKEInstr(
        CcuInstr* instr, uint16_t rmtCKEId, uint16_t locCKEId, uint16_t locCKEMask, uint16_t channelId,
        uint16_t setCKEId, uint16_t setCKEMask, uint16_t waitCKEId, uint16_t waitCKEMask, uint16_t clearType);
    void SyncGSAInstr(
    ...
    namespace CcuV2 {
        ...
        void LoadSqeArgsToX(
            CcuInstr* instr, uint16_t xnId, uint16_t sqeArgsId, uint16_t setCKEId = 0, uint16_t setCKEMask = 0);
        void
        LoadImdToXn(CcuInstr* instr, uint16_t xnId, uint64_t immediate, uint16_t setCKEId = 0, uint16_t setCKEMask = 0);
        void ClearX(
            CcuInstr* instr, uint16_t xnId, uint16_t xmId, uint16_t xnIdMode = 0, uint16_t xmIdMode = 0,
        ...
        void
        AssignI(CcuInstr* instr, uint16_t result, uint64_t operand, uint16_t setCKEId = 0, uint16_t setCKEMask = 0);

        void
        Add(CcuInstr* instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        void AddI(
            CcuInstr* instr, uint16_t result, uint16_t operand, uint16_t imm, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        void
        Sub(CcuInstr* instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        void SubI(
            CcuInstr* instr, uint16_t result, uint16_t operand, uint16_t imm, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        void
        Mul(CcuInstr* instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        void MulI(
            CcuInstr* instr, uint16_t result, uint16_t operand, uint16_t imm, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        ...
        void
        And(CcuInstr* instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        void
        Or(CcuInstr* instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId = 0,
           uint16_t setCKEMask = 0);
        void
        Xor(CcuInstr* instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        void Not(CcuInstr* instr, uint16_t result, uint16_t operand, uint16_t setCKEId = 0, uint16_t setCKEMask = 0);

        void
        SLL(CcuInstr* instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        void
        SRL(CcuInstr* instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        void
        SLA(CcuInstr* instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        void
        SRA(CcuInstr* instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId = 0,
            uint16_t setCKEMask = 0);
        ...
        void Loop(
            ...
            uint16_t contextId);
        void LoopGroup(
            CcuInstr* instr, uint16_t startLoopInstrId, uint16_t loopGroupConfig, uint16_t resOffset,
            uint16_t xnOffset);
        void Jump(

...
struct CcuRepResource {
    ...
    std::array<std::vector<CcuRep::MaskSignal>, MAX_CCU_IODIE_NUM> legacyBlockMaskSignal;
    ...
    std::array<std::vector<CcuRep::Variable>, MAX_CCU_IODIE_NUM> legacyContinuousVariable;
};

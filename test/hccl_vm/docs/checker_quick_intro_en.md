...
flowchart LR
    subgraph R0["rank0"]
        direction TB
        subgraph R0S0["Operator Main Stream (streamId specified by opDetails.streamId)"]
            direction LR
    ...
    subgraph R1["rank1"]
        direction TB
        subgraph R1S0["Operator Main Stream (streamId specified by opDetails.streamId)"]
            direction LR
...
flowchart LR
    ...
    subgraph MAIN["rank0 / Operator Main Stream (streamId specified by opDetails.streamId)"]
        M0["TRANS_MEM"]

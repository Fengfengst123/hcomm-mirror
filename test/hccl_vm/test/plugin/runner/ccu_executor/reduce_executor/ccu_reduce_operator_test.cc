...
extern bool ReduceAddProcess(const void *srcBuf, void *dstBuf, uint64_t length,
                             uint16_t dataType, RunnerCcuVersion version);
extern bool ReduceMaxProcess(const void *srcBuf, void *dstBuf, uint64_t length,
                             uint16_t dataType, RunnerCcuVersion version);
extern bool ReduceMinProcess(const void *srcBuf, void *dstBuf, uint64_t length,
                             uint16_t dataType, RunnerCcuVersion version);

template <typename T>
bool ReduceAddElements(const T *srcBuf, T *dstBuf, uint64_t count,
                       uint16_t dataType, RunnerCcuVersion version) {
    return ReduceAddProcess(srcBuf, dstBuf, count * sizeof(T), dataType,
                            version);
}

template <typename T>
bool ReduceMaxElements(const T *srcBuf, T *dstBuf, uint64_t count,
                       uint16_t dataType, RunnerCcuVersion version) {
    return ReduceMaxProcess(srcBuf, dstBuf, count * sizeof(T), dataType,
                            version);
}

template <typename T>
bool ReduceMinElements(const T *srcBuf, T *dstBuf, uint64_t count,
                       uint16_t dataType, RunnerCcuVersion version) {
    return ReduceMinProcess(srcBuf, dstBuf, count * sizeof(T), dataType,
                            version);
}

template <typename T>
bool ReduceElements(const T *srcBuf, T *dstBuf, uint64_t count,
                    uint16_t dataType, uint16_t op, RunnerCcuVersion version) {
    return ReduceProcess(srcBuf, dstBuf, count * sizeof(T), dataType, op,
                         version);
}
...
TEST_F(ReduceOperatorTest, ReduceAddProcessInt8) {
    ...
    ReduceAddElements(src, dst, 4, TransMemReduceDataTypeV1::INT8_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 11);
    EXPECT_EQ(dst[1], -3);
    EXPECT_EQ(dst[2], 0);
    EXPECT_EQ(dst[3], 4);
...
TEST_F(ReduceOperatorTest, ReduceAddProcessInt16) {
    ...
    ReduceAddElements(src, dst, 3, TransMemReduceDataTypeV1::INT16_V1,
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceAddProcessInt32) {
    ...
    ReduceAddElements(src, dst, 4, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 11);
    EXPECT_EQ(dst[1], 22);
    EXPECT_EQ(dst[2], 33);
...
TEST_F(ReduceOperatorTest, ReduceAddProcessUint8) {
    ...
    ReduceAddElements(src, dst, 4, TransMemReduceDataTypeV1::UINT8_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 11);
    EXPECT_EQ(dst[1], 22);
    EXPECT_EQ(dst[2], 33);
...
TEST_F(ReduceOperatorTest, ReduceAddProcessUint16) {
    ...
    ReduceAddElements(src, dst, 3, TransMemReduceDataTypeV1::UINT16_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 1100);
...
TEST_F(ReduceOperatorTest, ReduceAddProcessUint32) {
    ...
    ReduceAddElements(src, dst, 3, TransMemReduceDataTypeV1::UINT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 1100);
    EXPECT_EQ(dst[1], 2200);
    EXPECT_EQ(dst[2], 3300);
...
TEST_F(ReduceOperatorTest, ReduceAddProcessFP32) {
    ...
    ReduceAddElements(src, dst, 4, TransMemReduceDataTypeV1::FP32_V1,
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceAddProcessUnsupportedInvalid) {
    int32_t src[4] = {1, 2, 3, 4};
    int32_t dst[4] = {10, 20, 30, 40};
    EXPECT_FALSE(ReduceAddElements(src, dst, 4,
                                   TransMemReduceDataTypeV1::INVALID_V1,
                                   RunnerCcuVersion::CCU_V1));
}
...
TEST_F(ReduceOperatorTest, ReduceAddProcessUnsupportedBF16) {
    ...
    int32_t dst[4] = {10, 20, 30, 40};
    EXPECT_FALSE(ReduceAddElements(src, dst, 4,
                                   TransMemReduceDataTypeV1::BF16_V1,
                                   RunnerCcuVersion::CCU_V1));
}
...
TEST_F(ReduceOperatorTest, ReduceAddProcessSupportsFP16Normal) {
    ...
    EXPECT_TRUE(ReduceAddElements(src, dst, 4,
...
TEST_F(ReduceOperatorTest, ReduceAddProcessUnsupportedFP16Sat) {
    ...
    int32_t dst[4] = {10, 20, 30, 40};
    EXPECT_FALSE(ReduceAddElements(src, dst, 4,
                                   TransMemReduceDataTypeV1::FP16_SAT_V1,
                                   RunnerCcuVersion::CCU_V1));
}
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessInt8) {
    ...
    ReduceMaxElements(src, dst, 3, TransMemReduceDataTypeV1::INT8_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 10);
    EXPECT_EQ(dst[1], 10);
    EXPECT_EQ(dst[2], 30);
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessInt16) {
    ...
    ReduceMaxElements(src, dst, 3, TransMemReduceDataTypeV1::INT16_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 100);
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessInt32) {
    ...
    ReduceMaxElements(src, dst, 4, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 10);
    EXPECT_EQ(dst[1], 100);
    EXPECT_EQ(dst[2], 300);
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessUint8) {
    ...
    ReduceMaxElements(src, dst, 3, TransMemReduceDataTypeV1::UINT8_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 10);
    EXPECT_EQ(dst[1], 200);
    EXPECT_EQ(dst[2], 30);
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessUint16) {
    ...
    ReduceMaxElements(src, dst, 3, TransMemReduceDataTypeV1::UINT16_V1,
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessUint32) {
    ...
    ReduceMaxElements(src, dst, 3, TransMemReduceDataTypeV1::UINT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 1000);
    EXPECT_EQ(dst[1], 2000);
    EXPECT_EQ(dst[2], 3000);
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessFP32) {
    ...
    ReduceMaxElements(src, dst, 4, TransMemReduceDataTypeV1::FP32_V1,
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessUnsupportedBF16) {
    int32_t src[4] = {1, 2, 3, 4};
    int32_t dst[4] = {10, 20, 30, 40};
    EXPECT_FALSE(ReduceMaxElements(src, dst, 4,
                                   TransMemReduceDataTypeV1::BF16_V1,
                                   RunnerCcuVersion::CCU_V1));
}
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessSupportsFP16Normal) {
    ...
    EXPECT_TRUE(ReduceMaxElements(src, dst, 4,
                                  TransMemReduceDataTypeV1::FP16_NORMAL_V1,
                                  RunnerCcuVersion::CCU_V1));
...
TEST_F(ReduceOperatorTest, ReduceMinProcessInt8) {
    int8_t src[3] = {-5, 10, 3};
    int8_t dst[3] = {10, -20, 30};
    ReduceMinElements(src, dst, 3, TransMemReduceDataTypeV1::INT8_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], -5);
    EXPECT_EQ(dst[1], -20);
    EXPECT_EQ(dst[2], 3);
...
TEST_F(ReduceOperatorTest, ReduceMinProcessInt16) {
    int16_t src[3] = {100, -200, 300};
    int16_t dst[3] = {50, 2000, -500};
    ReduceMinElements(src, dst, 3, TransMemReduceDataTypeV1::INT16_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 50);
    EXPECT_EQ(dst[1], -200);
    EXPECT_EQ(dst[2], -500);
...
TEST_F(ReduceOperatorTest, ReduceMinProcessInt32) {
    ...
    ReduceMinElements(src, dst, 4, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 5);
    EXPECT_EQ(dst[1], 1);
    EXPECT_EQ(dst[2], 3);
...
TEST_F(ReduceOperatorTest, ReduceMinProcessUint8) {
    uint8_t src[3] = {5, 1, 3};
    uint8_t dst[3] = {10, 20, 30};
    ReduceMinElements(src, dst, 3, TransMemReduceDataTypeV1::UINT8_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 5);
    EXPECT_EQ(dst[1], 1);
    EXPECT_EQ(dst[2], 3);
...
TEST_F(ReduceOperatorTest, ReduceMinProcessUint16) {
    uint16_t src[3] = {100, 2000, 300};
    uint16_t dst[3] = {1000, 200, 3000};
    ReduceMinElements(src, dst, 3, TransMemReduceDataTypeV1::UINT16_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 100);
    EXPECT_EQ(dst[1], 200);
    EXPECT_EQ(dst[2], 300);
...
TEST_F(ReduceOperatorTest, ReduceMinProcessUint32) {
    uint32_t src[3] = {100, 2000, 300};
    uint32_t dst[3] = {1000, 200, 3000};
    ReduceMinElements(src, dst, 3, TransMemReduceDataTypeV1::UINT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 100);
    EXPECT_EQ(dst[1], 200);
    EXPECT_EQ(dst[2], 300);
...
TEST_F(ReduceOperatorTest, ReduceMinProcessFP32) {
    ...
    ReduceMinElements(src, dst, 4, TransMemReduceDataTypeV1::FP32_V1,
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceMinProcessSupportsFP16Normal) {
    ...
    EXPECT_TRUE(ReduceMinElements(src, dst, 4,
                                  TransMemReduceDataTypeV1::FP16_NORMAL_V1,
                                  RunnerCcuVersion::CCU_V1));
...
TEST_F(ReduceOperatorTest, ReduceMinProcessUnsupportedBF16) {
    int32_t src[4] = {1, 2, 3, 4};
    int32_t dst[4] = {10, 20, 30, 40};
    EXPECT_FALSE(ReduceMinElements(src, dst, 4,
                                   TransMemReduceDataTypeV1::BF16_V1,
                                   RunnerCcuVersion::CCU_V1));
}
...
TEST_F(ReduceOperatorTest, ReduceProcessOpMax) {
    int32_t src[4] = {5, 100, 30, 10};
    int32_t dst[4] = {10, 20, 300, 40};
    ReduceElements(src, dst, 4, TransMemReduceDataTypeV1::INT32_V1, 8,
                   RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 10);
    EXPECT_EQ(dst[1], 100);
    EXPECT_EQ(dst[2], 300);
...
TEST_F(ReduceOperatorTest, ReduceProcessOpMin) {
    int32_t src[4] = {5, 1, 30, 10};
    int32_t dst[4] = {10, 20, 3, 40};
    ReduceElements(src, dst, 4, TransMemReduceDataTypeV1::INT32_V1, 9,
                   RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 5);
    EXPECT_EQ(dst[1], 1);
    EXPECT_EQ(dst[2], 3);
...
TEST_F(ReduceOperatorTest, ReduceProcessOpSum) {
    int32_t src[4] = {1, 2, 3, 4};
    int32_t dst[4] = {10, 20, 30, 40};
    ReduceElements(src, dst, 4, TransMemReduceDataTypeV1::INT32_V1, 10,
                   RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 11);
    EXPECT_EQ(dst[1], 22);
    EXPECT_EQ(dst[2], 33);
...
TEST_F(ReduceOperatorTest, ReduceProcessOpEqualNotSupported) {
    int32_t src[4] = {1, 2, 3, 4};
    int32_t dst[4] = {10, 20, 30, 40};
    EXPECT_FALSE(ReduceElements(src, dst, 4, TransMemReduceDataTypeV1::INT32_V1,
                                11, RunnerCcuVersion::CCU_V1));
}
...
TEST_F(ReduceOperatorTest, ReduceProcessOpDefaultNotSupported) {
    ...
    int32_t dst[4] = {10, 20, 30, 40};
    EXPECT_FALSE(ReduceElements(src, dst, 4, TransMemReduceDataTypeV1::INT32_V1,
                                99, RunnerCcuVersion::CCU_V1));
}

TEST_F(ReduceOperatorTest, ReduceAddProcessZeroLength) {
    int32_t src[1] = {1};
    int32_t dst[1] = {10};
    ReduceAddElements(src, dst, 0, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 10);
}
...
TEST_F(ReduceOperatorTest, ReduceAddProcessSingleElement) {
    int32_t src[1] = {5};
    int32_t dst[1] = {10};
    ReduceAddElements(src, dst, 1, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 15);
}
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessZeroLength) {
    int32_t src[1] = {5};
    int32_t dst[1] = {10};
    ReduceMaxElements(src, dst, 0, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 10);
}
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessSingleElement) {
    int32_t src[1] = {5};
    int32_t dst[1] = {10};
    ReduceMaxElements(src, dst, 1, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 10);
}
...
TEST_F(ReduceOperatorTest, ReduceMinProcessZeroLength) {
    int32_t src[1] = {5};
    int32_t dst[1] = {10};
    ReduceMinElements(src, dst, 0, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 10);
}
...
TEST_F(ReduceOperatorTest, ReduceMinProcessSingleElement) {
    int32_t src[1] = {5};
    int32_t dst[1] = {10};
    ReduceMinElements(src, dst, 1, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 5);
}
...
TEST_F(ReduceOperatorTest, ReduceAddProcessFP32Negative) {
    ...
    ReduceAddElements(src, dst, 3, TransMemReduceDataTypeV1::FP32_V1,
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessFP32Equal) {
    ...
    ReduceMaxElements(src, dst, 3, TransMemReduceDataTypeV1::FP32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_FLOAT_EQ(dst[0], 10.0f);
...
TEST_F(ReduceOperatorTest, ReduceMinProcessFP32Equal) {
    float src[3] = {10.0f, 20.0f, 30.0f};
    float dst[3] = {10.0f, 20.0f, 30.0f};
    ReduceMinElements(src, dst, 3, TransMemReduceDataTypeV1::FP32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_FLOAT_EQ(dst[0], 10.0f);
    EXPECT_FLOAT_EQ(dst[1], 20.0f);
    EXPECT_FLOAT_EQ(dst[2], 30.0f);
...
TEST_F(ReduceOperatorTest, ReduceProcessOpMaxWithFP32) {
    ...
    float dst[3] = {10.0f, 20.0f, 30.0f};
    ReduceElements(src, dst, 3, TransMemReduceDataTypeV1::FP32_V1, 8,
                   RunnerCcuVersion::CCU_V1);
    EXPECT_FLOAT_EQ(dst[0], 10.0f);
    EXPECT_FLOAT_EQ(dst[1], 200.0f);
    EXPECT_FLOAT_EQ(dst[2], 30.0f);
...
TEST_F(ReduceOperatorTest, ReduceProcessOpMinWithFP32) {
    float src[3] = {5.0f, 200.0f, 3.0f};
    float dst[3] = {10.0f, 20.0f, 30.0f};
    ReduceElements(src, dst, 3, TransMemReduceDataTypeV1::FP32_V1, 9,
                   RunnerCcuVersion::CCU_V1);
    EXPECT_FLOAT_EQ(dst[0], 5.0f);
    EXPECT_FLOAT_EQ(dst[1], 20.0f);
    EXPECT_FLOAT_EQ(dst[2], 3.0f);
...
TEST_F(ReduceOperatorTest, ReduceProcessOpSumWithFP32) {
    float src[3] = {1.5f, 2.5f, 3.5f};
    float dst[3] = {10.0f, 20.0f, 30.0f};
    ReduceElements(src, dst, 3, TransMemReduceDataTypeV1::FP32_V1, 10,
                   RunnerCcuVersion::CCU_V1);
    EXPECT_FLOAT_EQ(dst[0], 11.5f);
    EXPECT_FLOAT_EQ(dst[1], 22.5f);
    EXPECT_FLOAT_EQ(dst[2], 33.5f);
...
TEST_F(ReduceOperatorTest, ReduceProcessOpMaxUnsupportedType) {
    int32_t src[4] = {1, 2, 3, 4};
    int32_t dst[4] = {10, 20, 30, 40};
    EXPECT_FALSE(ReduceElements(src, dst, 4, TransMemReduceDataTypeV1::BF16_V1,
                                8, RunnerCcuVersion::CCU_V1));
}
...
TEST_F(ReduceOperatorTest, ReduceProcessOpMinUnsupportedType) {
    ...
    int32_t dst[4] = {10, 20, 30, 40};
    EXPECT_FALSE(ReduceElements(src, dst, 4, TransMemReduceDataTypeV1::BF16_V1,
                                9, RunnerCcuVersion::CCU_V1));
}

TEST_F(ReduceOperatorTest, ReduceProcessOpSumUnsupportedType) {
    int32_t src[4] = {1, 2, 3, 4};
    int32_t dst[4] = {10, 20, 30, 40};
    EXPECT_FALSE(ReduceElements(src, dst, 4,
                                TransMemReduceDataTypeV1::INVALID_V1, 10,
                                RunnerCcuVersion::CCU_V1));
}
...
TEST_F(ReduceOperatorTest, ReduceProcessOpTwelveNotSupported) {
    ...
    int32_t dst[4] = {10, 20, 30, 40};
    EXPECT_FALSE(ReduceElements(src, dst, 4, TransMemReduceDataTypeV1::INT32_V1,
                                12, RunnerCcuVersion::CCU_V1));
}

TEST_F(ReduceOperatorTest, ReduceAddProcessUint8Overflow) {
    uint8_t src[2] = {200, 255};
    uint8_t dst[2] = {100, 1};
    ReduceAddElements(src, dst, 2, TransMemReduceDataTypeV1::UINT8_V1,
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceAddProcessInt16LargeValues) {
    ...
    ReduceAddElements(src, dst, 2, TransMemReduceDataTypeV1::INT16_V1,
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceAddProcessUint32LargeValues) {
    ...
    ReduceAddElements(src, dst, 2, TransMemReduceDataTypeV1::UINT32_V1,
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessUint32LargeValues) {
    ...
    uint32_t dst[2] = {3000000u, 4000000u};
    ReduceMaxElements(src, dst, 2, TransMemReduceDataTypeV1::UINT32_V1,
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceMinProcessUint32LargeValues) {
    uint32_t src[2] = {5000000u, 1000000u};
    uint32_t dst[2] = {3000000u, 4000000u};
    ReduceMinElements(src, dst, 2, TransMemReduceDataTypeV1::UINT32_V1,
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceAddProcessInt32Negative) {
    ...
    ReduceAddElements(src, dst, 3, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 9);
    EXPECT_EQ(dst[1], -22);
    EXPECT_EQ(dst[2], -3);
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessInt32Negative) {
    ...
    ReduceMaxElements(src, dst, 3, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], 10);
    EXPECT_EQ(dst[1], -5);
    EXPECT_EQ(dst[2], 30);
...
TEST_F(ReduceOperatorTest, ReduceMinProcessInt32Negative) {
    int32_t src[3] = {-1, -20, 30};
    int32_t dst[3] = {10, -5, -30};
    ReduceMinElements(src, dst, 3, TransMemReduceDataTypeV1::INT32_V1,
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst[0], -1);
    EXPECT_EQ(dst[1], -20);
    EXPECT_EQ(dst[2], -30);
...
TEST_F(ReduceOperatorTest, ReduceAddProcessAllSupportedDataTypes) {
    int8_t src8[2] = {1, 2};
    int8_t dst8[2] = {10, 20};
    ReduceAddElements(src8, dst8, 2,
                      static_cast<uint16_t>(TransMemReduceDataTypeV1::INT8_V1),
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst8[0], 11);

    int16_t src16[2] = {1, 2};
    int16_t dst16[2] = {10, 20};
    ReduceAddElements(src16, dst16, 2,
                      static_cast<uint16_t>(TransMemReduceDataTypeV1::INT16_V1),
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst16[0], 11);

    int32_t src32[2] = {1, 2};
    int32_t dst32[2] = {10, 20};
    ReduceAddElements(src32, dst32, 2,
                      static_cast<uint16_t>(TransMemReduceDataTypeV1::INT32_V1),
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst32[0], 11);

    uint8_t usrc8[2] = {1, 2};
    uint8_t udst8[2] = {10, 20};
    ReduceAddElements(usrc8, udst8, 2,
                      static_cast<uint16_t>(TransMemReduceDataTypeV1::UINT8_V1),
                      RunnerCcuVersion::CCU_V1);
    ...
    ReduceAddElements(
        usrc16, udst16, 2,
        static_cast<uint16_t>(TransMemReduceDataTypeV1::UINT16_V1),
        RunnerCcuVersion::CCU_V1);
    ...
    ReduceAddElements(
        usrc32, udst32, 2,
        static_cast<uint16_t>(TransMemReduceDataTypeV1::UINT32_V1),
        RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(udst32[0], 11);

    float fsrc[2] = {1.0f, 2.0f};
    float fdst[2] = {10.0f, 20.0f};
    ReduceAddElements(fsrc, fdst, 2,
                      static_cast<uint16_t>(TransMemReduceDataTypeV1::FP32_V1),
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceMaxProcessAllSupportedDataTypes) {
    ...
    int16_t src16[2] = {5, 2};
    int16_t dst16[2] = {10, 20};
    ReduceMaxElements(src16, dst16, 2,
                      static_cast<uint16_t>(TransMemReduceDataTypeV1::INT16_V1),
                      RunnerCcuVersion::CCU_V1);
    ...
    int32_t src32[2] = {5, 2};
    int32_t dst32[2] = {10, 20};
    ReduceMaxElements(src32, dst32, 2,
                      static_cast<uint16_t>(TransMemReduceDataTypeV1::INT32_V1),
                      RunnerCcuVersion::CCU_V1);
    ...
    uint8_t usrc8[2] = {5, 2};
    uint8_t udst8[2] = {10, 20};
    ReduceMaxElements(usrc8, udst8, 2,
                      static_cast<uint16_t>(TransMemReduceDataTypeV1::UINT8_V1),
                      RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceMinProcessAllSupportedDataTypes) {
    ...
    int16_t src16[2] = {5, 2};
    int16_t dst16[2] = {10, 20};
    ReduceMinElements(src16, dst16, 2,
                      static_cast<uint16_t>(TransMemReduceDataTypeV1::INT16_V1),
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst16[0], 5);
    ...
    int32_t src32[2] = {5, 2};
    int32_t dst32[2] = {10, 20};
    ReduceMinElements(src32, dst32, 2,
                      static_cast<uint16_t>(TransMemReduceDataTypeV1::INT32_V1),
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dst32[0], 5);
    ...
    uint8_t usrc8[2] = {5, 2};
    uint8_t udst8[2] = {10, 20};
    ReduceMinElements(usrc8, udst8, 2,
                      static_cast<uint16_t>(TransMemReduceDataTypeV1::UINT8_V1),
                      RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(udst8[0], 5);
...
TEST_F(ReduceOperatorTest, ReduceProcessAllOpsWithInt8) {
    ...
    ReduceElements(src, dstMax, 2, TransMemReduceDataTypeV1::INT8_V1, 8,
                   RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dstMax[0], 5);
    EXPECT_EQ(dstMax[1], 10);

    ReduceElements(src, dstMin, 2, TransMemReduceDataTypeV1::INT8_V1, 9,
                   RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dstMin[0], 3);
    EXPECT_EQ(dstMin[1], 2);

    ReduceElements(src, dstSum, 2, TransMemReduceDataTypeV1::INT8_V1, 10,
                   RunnerCcuVersion::CCU_V1);
...
TEST_F(ReduceOperatorTest, ReduceProcessAllOpsWithUint16) {
    ...
    ReduceElements(src, dstMax, 2, TransMemReduceDataTypeV1::UINT16_V1, 8,
                   RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dstMax[0], 5);
    EXPECT_EQ(dstMax[1], 10);

    ReduceElements(src, dstMin, 2, TransMemReduceDataTypeV1::UINT16_V1, 9,
                   RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dstMin[0], 3);
    EXPECT_EQ(dstMin[1], 2);

    ReduceElements(src, dstSum, 2, TransMemReduceDataTypeV1::UINT16_V1, 10,
                   RunnerCcuVersion::CCU_V1);
    EXPECT_EQ(dstSum[0], 8);
    EXPECT_EQ(dstSum[1], 12);
}

...
TEST_F(CheckUtilsTest, CalcDataSize_Int8) {
    uint64_t dataSize = 0;
    CalcDataSize(HcclCMDType::HCCL_CMD_ALLREDUCE, 100,
                 HcclDataType::HCCL_DATA_TYPE_INT8, dataSize);
...
TEST_F(CheckUtilsTest, CalcDataSize_Int32) {
    uint64_t dataSize = 0;
    CalcDataSize(HcclCMDType::HCCL_CMD_ALLREDUCE, 100,
                 HcclDataType::HCCL_DATA_TYPE_INT32, dataSize);
...
TEST_F(CheckUtilsTest, CalcDataSize_Fp16) {
    uint64_t dataSize = 0;
    CalcDataSize(HcclCMDType::HCCL_CMD_ALLREDUCE, 100,
                 HcclDataType::HCCL_DATA_TYPE_FP16, dataSize);
...
TEST_F(CheckUtilsTest, CalcDataSize_Fp32) {
    uint64_t dataSize = 0;
    CalcDataSize(HcclCMDType::HCCL_CMD_ALLREDUCE, 100,
                 HcclDataType::HCCL_DATA_TYPE_FP32, dataSize);
    EXPECT_EQ(dataSize, 400);
}

TEST_F(CheckUtilsTest, CalcDataSize_ZeroCount) {
    uint64_t dataSize = 0;
    CalcDataSize(HcclCMDType::HCCL_CMD_ALLREDUCE, 0,
                 HcclDataType::HCCL_DATA_TYPE_INT32, dataSize);
...
TEST_F(CheckUtilsTest, CalcDataSize_LargeCount) {
    uint64_t dataSize = 0;
    CalcDataSize(HcclCMDType::HCCL_CMD_ALLREDUCE, 1000000,
                 HcclDataType::HCCL_DATA_TYPE_INT32, dataSize);
...
TEST_F(CheckUtilsTest, CalcInputOutputSize_AllReduce) {
    ...
    CalcInputOutputSize(HcclCMDType::HCCL_CMD_ALLREDUCE, 4, 100,
                        HcclDataType::HCCL_DATA_TYPE_INT32, inputSize,
                        outputSize, 0, 0, 0, {}, {});
...
TEST_F(CheckUtilsTest, CalcInputOutputSize_Broadcast) {
    uint64_t inputSize = 0;
    uint64_t outputSize = 0;
    CalcInputOutputSize(HcclCMDType::HCCL_CMD_BROADCAST, 4, 100,
                        HcclDataType::HCCL_DATA_TYPE_INT32, inputSize,
                        outputSize, 0, 0, 0, {}, {});
    EXPECT_EQ(inputSize, 400);
    EXPECT_EQ(outputSize, 400);
...
TEST_F(CheckUtilsTest, CalcInputOutputSize_Send) {
    uint64_t inputSize = 0;
    uint64_t outputSize = 0;
    CalcInputOutputSize(HcclCMDType::HCCL_CMD_SEND, 4, 100,
                        HcclDataType::HCCL_DATA_TYPE_INT32, inputSize,
                        outputSize, 0, 0, 1, {}, {});
    EXPECT_EQ(inputSize, 400);
...
TEST_F(CheckUtilsTest, CalcInputOutputSize_Receive) {
    uint64_t inputSize = 0;
    uint64_t outputSize = 0;
    CalcInputOutputSize(HcclCMDType::HCCL_CMD_RECEIVE, 4, 100,
                        HcclDataType::HCCL_DATA_TYPE_INT32, inputSize,
                        outputSize, 1, 0, 1, {}, {});
...
TEST_F(CheckUtilsTest, CalcInputOutputSize_Reduce) {
    uint64_t inputSize = 0;
    uint64_t outputSize = 0;
    CalcInputOutputSize(HcclCMDType::HCCL_CMD_REDUCE, 4, 100,
                        HcclDataType::HCCL_DATA_TYPE_INT32, inputSize,
                        outputSize, 0, 0, 0, {}, {});
    EXPECT_EQ(inputSize, 400);
    EXPECT_EQ(outputSize, 400);
...
TEST_F(CheckUtilsTest, CalcInputOutputSize_AllGather) {
    uint64_t inputSize = 0;
    uint64_t outputSize = 0;
    CalcInputOutputSize(HcclCMDType::HCCL_CMD_ALLGATHER, 4, 100,
                        HcclDataType::HCCL_DATA_TYPE_INT32, inputSize,
                        outputSize, 0, 0, 0, {}, {});
    EXPECT_EQ(inputSize, 400);
...
TEST_F(CheckUtilsTest, CalcInputOutputSize_ReduceScatter) {
    uint64_t inputSize = 0;
    uint64_t outputSize = 0;
    CalcInputOutputSize(HcclCMDType::HCCL_CMD_REDUCE_SCATTER, 4, 100,
                        HcclDataType::HCCL_DATA_TYPE_INT32, inputSize,
                        outputSize, 0, 0, 0, {}, {});
...
TEST_F(CheckUtilsTest, CalcInputOutputSize_Scatter) {
    uint64_t inputSize = 0;
    uint64_t outputSize = 0;
    CalcInputOutputSize(HcclCMDType::HCCL_CMD_SCATTER, 4, 100,
                        HcclDataType::HCCL_DATA_TYPE_INT32, inputSize,
                        outputSize, 0, 0, 0, {}, {});
    EXPECT_EQ(inputSize, 1600);
    EXPECT_EQ(outputSize, 400);
...
TEST_F(CheckUtilsTest, CalcInputOutputSize_BatchSendRecv) {
    uint64_t inputSize = 0;
    uint64_t outputSize = 0;
    CalcInputOutputSize(HcclCMDType::HCCL_CMD_BATCH_SEND_RECV, 4, 100,
                        HcclDataType::HCCL_DATA_TYPE_INT32, inputSize,
                        outputSize, 0, 0, 0, {}, {});
    EXPECT_EQ(inputSize, 400);
    EXPECT_EQ(outputSize, 400);
...
TEST_F(CheckUtilsTest, CalcInputOutputSize_UnsupportedOp) {
    uint64_t inputSize = 0;
    uint64_t outputSize = 0;
    CalcInputOutputSize(HcclCMDType::HCCL_CMD_INVALID, 4, 100,
                        HcclDataType::HCCL_DATA_TYPE_INT32, inputSize,
                        outputSize, 0, 0, 0, {}, {});

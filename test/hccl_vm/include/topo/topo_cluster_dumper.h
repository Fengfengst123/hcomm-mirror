...
class ClusterTopoDumper {
  ...
  private:
    static void DumpNetwork(const Network &network, std::ostream &os,
                            int indent);
    static void DumpSuperPod(const SuperPod &superpod, std::ostream &os,
                             int indent);
    ...
    static void DumpLinkPortRef(const LinkPortRef &ref, std::ostream &os,
                                int indent);

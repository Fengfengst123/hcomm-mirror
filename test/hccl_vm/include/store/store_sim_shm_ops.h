...
/*锁定指定的内存该内存由ShmCreate/ShmOpen创建，整块锁定，0 成功，-1
 * 失败,内部使用POSIX信号量或者futex/atomic compare-and-swap实现细粒度锁*/
int ShmLock(void *shm);

/*解锁指定的内存该内存由ShmCreate/ShmOpen创建，整块锁定，0 成功，-1
 * 失败，内部使用POSIX信号量或者futex/atomic compare-and-swap实现细粒度锁*/

...
const std::map<TransMemReduceDataTypeV1,
               std::function<void(const void *, void *, uint64_t)>>
    transmemReduceAddFuncMapV1 = {
...
const std::map<TransMemReduceDataTypeV2,
               std::function<void(const void *, void *, uint64_t)>>
    transmemReduceAddFuncMapV2 = {
...
bool ReduceAddProcess(const void *srcBuf, void *dstBuf, uint64_t length,
                      uint16_t dataType, RunnerCcuVersion version) {
    HCCL_VM_INFO("ReduceAddProcess dataType {} length {} srcBuf {} dstBuf {}",
                 dataType, length, srcBuf, dstBuf);

    if (version == RunnerCcuVersion::CCU_V1) {
        TransMemReduceDataTypeV1 type =
            static_cast<TransMemReduceDataTypeV1>(dataType);
        ...
        TransMemReduceDataTypeV2 type =
            static_cast<TransMemReduceDataTypeV2>(dataType);
...
bool ReduceMaxProcess(const void *srcBuf, void *dstBuf, uint64_t length,
                      uint16_t dataType, RunnerCcuVersion version) {
    HCCL_VM_INFO("ReduceMaxProcess dataType {} length {} srcBuf {} dstBuf {}",
                 dataType, length, srcBuf, dstBuf);
...
bool ReduceMinProcess(const void *srcBuf, void *dstBuf, uint64_t length,
                      uint16_t dataType, RunnerCcuVersion version) {
    HCCL_VM_INFO("ReduceMinProcess dataType {} length {} srcBuf {} dstBuf {}",
                 dataType, length, srcBuf, dstBuf);

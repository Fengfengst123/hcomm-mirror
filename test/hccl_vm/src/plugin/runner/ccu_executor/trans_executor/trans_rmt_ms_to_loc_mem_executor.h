...
#ifndef HCCL_SIM_TRANS_RMTMS_TO_LOCMEM_EXECUTOR_H
#define HCCL_SIM_TRANS_RMTMS_TO_LOCMEM_EXECUTOR_H
...
class TransRmtMSToLocMemExecutor : public CcuExecutorBase {
  public:
    explicit TransRmtMSToLocMemExecutor(int streamId, int rankId, int dieId,
                                        const hcomm::CcuRep::CcuInstr &instr,
                                        CcuSimulator *ccuSimulator)
        : CcuExecutorBase(streamId, rankId, dieId, instr, ccuSimulator) {}
    TransRmtMSToLocMemExecutor() = default;
    ~TransRmtMSToLocMemExecutor() = default;
...
#endif // HCCL_SIM_TRANS_RMTMS_TO_LOCMEM_EXECUTOR_H

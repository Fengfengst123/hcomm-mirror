...
#ifndef HCCL_SIM_TRANS_RMTMEM_TO_LOCMEM_EXECUTOR_H
#define HCCL_SIM_TRANS_RMTMEM_TO_LOCMEM_EXECUTOR_H
...
class TransRmtMemToLocMemExecutor : public CcuExecutorBase {
  public:
    explicit TransRmtMemToLocMemExecutor(int streamId, int rankId, int dieId,
...
#endif // HCCL_SIM_TRANS_RMTMEM_TO_LOCMEM_EXECUTOR_H

...
REG_CCU_EXECUTOR_CREATE_FUNC(SimCcuV1::TRANS_TYPE, SimCcuV1::SYNCXN_CODE,
                             SyncXnExecutor);
...
void SyncXnExecutor::Process(CcuResourceManager &ccuResMgr) {
    ...
    HCCL_VM_INFO(
        "sync xn, rankId{}, dieId{}, xnId{}, channelId{}, locXnValue: {}",
        rmtCcu.first, rmtCcu.second, rmtXnId_, channelId_, locXnValue);
...
std::string SyncXnExecutor::Describe() {
    return HcclSim::StringFormat("[Simulation Execute] Wait CKE[%u:%04x], Sync "
                                 ...
                                 waitCKEId_, waitCKEMask_, locXnId_, rmtXnId_,

...
/**
 * AN "AS IS" BASIS, WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED,
 * for the full text of the License. Description: ccu executor -- trans loc ms
...
REG_CCU_EXECUTOR_CREATE_FUNC(SimCcuV1::TRANS_TYPE,
                             SimCcuV1::TRANSLOCMSTORMTMEM_CODE,
                             TransLocMSToRmtMemExecutor);
...
void TransLocMSToRmtMemExecutor::Process(CcuResourceManager &ccuResMgr) {
    ...
    HCCL_VM_DEBUG("locCcu[{}:{}] Trans data "
                  ...
                  rankId_, dieId_, locMSId_, rmtGSAId_, rmtAddr, lengthXnId_,
                  transLength_);
    bool ret =

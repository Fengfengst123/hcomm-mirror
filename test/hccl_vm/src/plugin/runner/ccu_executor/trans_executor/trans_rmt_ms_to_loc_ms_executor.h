...
#ifndef HCCL_SIM_TRANS_RMTMS_TO_LOCMS_EXECUTOR_H
#define HCCL_SIM_TRANS_RMTMS_TO_LOCMS_EXECUTOR_H
...
class TransRmtMSToLocMSExecutor : public CcuExecutorBase {
  public:
    explicit TransRmtMSToLocMSExecutor(int streamId, int rankId, int dieId,
...
#endif // HCCL_SIM_TRANS_RMTMS_TO_LOCMS_EXECUTOR_H

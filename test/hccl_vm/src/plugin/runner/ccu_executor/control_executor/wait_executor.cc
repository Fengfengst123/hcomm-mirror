...
REG_CCU_EXECUTOR_CREATE_FUNC_V2(SimCcuV2::CTRL_TYPE, SimCcuV2::WAIT_CODE,
                                WaitExecutor);
...
void WaitExecutor::Run() {
    ...
    case 0: // 等于
        ...
        HCCL_VM_INFO(
            "When conditionXn{}{} equal to expectData{}{}, WaitFlag{} ",
    ...
    case 1: // 不等于
        updateNextInsIdx(conditionValue != expectedValue);
        HCCL_VM_INFO(
            "When conditionXn{}{} not equal to expectData{}{}, WaitFlag{} ",
            conditionXnId, conditionValue, expectedXnId, expectedValue,
            conditionValue != expectedValue);
        break;
    case 2: // 大于
        updateNextInsIdx(conditionValue > expectedValue);
        HCCL_VM_INFO(
            "When conditionXn{}{} greater than expectData{}{}, WaitFlag{} ",
            conditionXnId, conditionValue, expectedXnId, expectedValue,
            conditionValue > expectedValue);
        break;
    case 3: // 大于/等于
        updateNextInsIdx(conditionValue >= expectedValue);
        HCCL_VM_INFO("When conditionXn{}{} greater than or equal to "
                     "expectData{}{}, WaitFlag{} ",
                     conditionXnId, conditionValue, expectedXnId, expectedValue,
                     conditionValue >= expectedValue);
        break;
    case 4: // 小于
        updateNextInsIdx(conditionValue < expectedValue);
        HCCL_VM_INFO(
            "When conditionXn{}{} less than expectData{}{}, WaitFlag{} ",
            conditionXnId, conditionValue, expectedXnId, expectedValue,
            conditionValue < expectedValue);
        break;
    case 5: // 小于/等于
        updateNextInsIdx(conditionValue <= expectedValue);
        HCCL_VM_INFO("When conditionXn{}{} less than or equal to "
                     "expectData{}{}, WaitFlag{} ",
                     conditionXnId, conditionValue, expectedXnId, expectedValue,
                     conditionValue <= expectedValue);
        break;

...
/**
 * AN "AS IS" BASIS, WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED,
 * for the full text of the License. Description: ccu executor -- fence executor
 * Author: caiyifan
 */
...
REG_CCU_EXECUTOR_CREATE_FUNC_V2(SimCcuV2::CTRL_TYPE, SimCcuV2::FENCE_CODE,
                                FenceExecutor);
...
std::string FenceExecutor::Describe() {
    return HcclSim::StringFormat(
        "[FenceExecutor] V2 Fence instruction, no additional parameters\n");
}

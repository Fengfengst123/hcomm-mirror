...
REG_CCU_EXECUTOR_CREATE_FUNC(SimCcuV1::CTRL_TYPE, SimCcuV1::CLEARCKE_CODE,
                             ClearCkeExecutor);
REG_CCU_EXECUTOR_CREATE_FUNC_V2(SimCcuV2::CTRL_TYPE, SimCcuV2::CLEARCKE_CODE,
                                ClearCkeExecutor);
...
std::string ClearCkeExecutor::Describe() {
    return HcclSim::StringFormat("[Simulation Execute] Wait CKE[%u:%04x], "
                                 ...
                                 waitCKEId_, waitCKEMask_, clearCKEId_,
                                 clearMask_, clearType_);
}

...
REG_CCU_EXECUTOR_CREATE_FUNC_V1(SimCcuV1::LOAD_TYPE,
                                SimCcuV1::LOADSQEARGSTOXN_CODE,
                                LoadSqeArgsToXnExecutor);
REG_CCU_EXECUTOR_CREATE_FUNC_V2(SimCcuV2::LOAD_TYPE,
                                SimCcuV2::LOADSQEARGSTOXN_CODE,
                                LoadSqeArgsToXnExecutor);
...
void LoadSqeArgsToXnExecutor::Parser() {
    if (version_ == RunnerCcuVersion::CCU_V1) {
        ...
        HCCL_VM_ERROR("Unsupported CCU version: {}",

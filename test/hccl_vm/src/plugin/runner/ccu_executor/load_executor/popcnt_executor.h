...
/**
 * AN "AS IS" BASIS, WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED,
 * for the full text of the License. Description: ccu executor -- Popcnt
 * Executor Author: caiyifan
 */

#ifndef HCCL_SIM_POPCNT_EXECUTOR_H
#define HCCL_SIM_POPCNT_EXECUTOR_H
...
class PopcntExecutor : public CcuExecutorBase {
  public:
    explicit PopcntExecutor(int streamId, int rankId, int dieId,
                            const hcomm::CcuRep::CcuInstr &instr,
                            CcuSimulator *ccuSimulator)
        : CcuExecutorBase(streamId, rankId, dieId, instr, ccuSimulator) {}
    PopcntExecutor() = default;
    ~PopcntExecutor() = default;
...
#endif // HCCL_SIM_POPCNT_EXECUTOR_H

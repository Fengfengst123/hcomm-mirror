...
/**
 * AN "AS IS" BASIS, WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED,
 * for the full text of the License. Description: ccu executor -- Shr Executor
 * Author: caiyifan
 */

#include "shr_executor.h"
...
REG_CCU_EXECUTOR_CREATE_FUNC_V2(SimCcuV2::LOAD_TYPE, SimCcuV2::SHR_CODE,
                                ShrExecutor);

void ShrExecutor::Parser() {
    ValidateVersionExclusive(RunnerCcuVersion::CCU_V2, "ShrExecutor");
...
void ShrExecutor::Run() {
    ...
    case 0:
        ...
        HCCL_VM_INFO("Shr logical Xn{}{} >> Xm{}{} to Xd{}{}", xnId, xnValue,
                     xmId, xmValue, xdId_, xdValue);
        break;
    case 1:
        xdValue = static_cast<int64_t>(xnValue) >> xmValue;
        HCCL_VM_INFO("Shr arithmetic Xn{}{} >> Xm{}{} to Xd{}{}", xnId, xnValue,
                     xmId, xmValue, xdId_, xdValue);
        break;
    case 2:
        xdValue = (xnValue >> (xmValue & 0x3F)) |
                  (xnValue << (64 - (xmValue & 0x3F)));
        HCCL_VM_INFO("Shr rotate Xn{}{} >>> Xm{}{} to Xd{}{}", xnId, xnValue,
                     xmId, xmValue, xdId_, xdValue);
        break;
    default:
...
std::string ShrExecutor::Describe() {
    return HcclSim::StringFormat(
        "[ShrExecutor] xdId:[%u],xnId_[%u],xmId[%u],shiftType[%u]\n", xdId_,
        xnId_, xmId_, shiftType_);
}

CcuTrace::CcuInstrTraceDetail ShrExecutor::CollectTraceDetail() {

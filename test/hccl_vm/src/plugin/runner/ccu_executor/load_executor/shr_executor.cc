...
REG_CCU_EXECUTOR_CREATE_FUNC_V2(SimCcuV2::LOAD_TYPE, SimCcuV2::SHR_CODE, ShrExecutor);
...
void ShrExecutor::Run()
{
    ...
    switch (shiftType_) {
        case 0:
            ...
            HCCL_VM_INFO("Shr logical Xn{}{} >> Xm{}{} to Xd{}{}", xnId, xnValue, xmId, xmValue, xdId_, xdValue);
            break;
        case 1:
            xdValue = static_cast<int64_t>(xnValue) >> xmValue;
            HCCL_VM_INFO("Shr arithmetic Xn{}{} >> Xm{}{} to Xd{}{}", xnId, xnValue, xmId, xmValue, xdId_, xdValue);
            break;
        case 2:
            xdValue = (xnValue >> (xmValue & 0x3F)) | (xnValue << (64 - (xmValue & 0x3F)));
            HCCL_VM_INFO("Shr rotate Xn{}{} >>> Xm{}{} to Xd{}{}", xnId, xnValue, xmId, xmValue, xdId_, xdValue);
            break;
        default:

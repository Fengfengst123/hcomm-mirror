...
#ifndef HCCL_SIM_LOAD_EXECUTOR_H
#define HCCL_SIM_LOAD_EXECUTOR_H
...
class LoadExecutor : public CcuExecutorBase {
  public:
    explicit LoadExecutor(int streamId, int rankId, int dieId,
                          const hcomm::CcuRep::CcuInstr &instr,
                          CcuSimulator *ccuSimulator)
        : CcuExecutorBase(streamId, rankId, dieId, instr, ccuSimulator) {}
    LoadExecutor() = default;
    ~LoadExecutor() = default;
...
#endif // HCCL_SIM_LOAD_EXECUTOR_H

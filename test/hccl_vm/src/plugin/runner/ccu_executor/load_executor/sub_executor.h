...
#ifndef HCCL_SIM_SUB_EXECUTOR_H
#define HCCL_SIM_SUB_EXECUTOR_H
...
class SubExecutor : public CcuExecutorBase {
  public:
    explicit SubExecutor(int streamId, int rankId, int dieId,

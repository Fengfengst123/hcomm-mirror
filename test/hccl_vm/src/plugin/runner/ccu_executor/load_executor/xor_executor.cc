 ...
 * for the full text of the License. Description: ccu executor -- Xor Executor
 * Author: caiyifan
 */

#include "xor_executor.h"
...
REG_CCU_EXECUTOR_CREATE_FUNC_V2(SimCcuV2::LOAD_TYPE, SimCcuV2::XOR_CODE, XorExecutor);

void XorExecutor::Parser()
{
    ValidateVersionExclusive(RunnerCcuVersion::CCU_V2, "XorExecutor");
...
void XorExecutor::Run()
{
    ...
    HCCL_VM_INFO("Xor Xn{}{} ^ Xm{}{} to Xd{}{}", xnId, xnValue, xmId, xmValue, xdId_, xdValue);

...
/**
 * AN "AS IS" BASIS, WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED,
 * for the full text of the License. Description: ccu executor -- And Executor
 * Author: caiyifan
 */

#ifndef HCCL_SIM_AND_EXECUTOR_H
#define HCCL_SIM_AND_EXECUTOR_H
...
class AndExecutor : public CcuExecutorBase {
  public:
    explicit AndExecutor(int streamId, int rankId, int dieId,

...
#ifndef HCCL_SIM_XOR_EXECUTOR_H
#define HCCL_SIM_XOR_EXECUTOR_H
...
class XorExecutor : public CcuExecutorBase {
  public:
    explicit XorExecutor(int streamId, int rankId, int dieId,

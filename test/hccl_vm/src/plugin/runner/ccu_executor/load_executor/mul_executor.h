...
#ifndef HCCL_SIM_MUL_EXECUTOR_H
#define HCCL_SIM_MUL_EXECUTOR_H
...
class MulExecutor : public CcuExecutorBase {
  public:
    explicit MulExecutor(int streamId, int rankId, int dieId,

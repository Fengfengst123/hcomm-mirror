...
#ifndef HCCL_SIM_ADD_EXECUTOR_H
#define HCCL_SIM_ADD_EXECUTOR_H
...
class AddExecutor : public CcuExecutorBase {
  public:
    explicit AddExecutor(int streamId, int rankId, int dieId,

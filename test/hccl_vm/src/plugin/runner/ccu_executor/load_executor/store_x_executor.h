...
/**
 * AN "AS IS" BASIS, WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED,
 * for the full text of the License. Description: ccu executor -- StoreX
 * Executor Author: caiyifan
 */

#ifndef HCCL_SIM_STOREX_EXECUTOR_H
#define HCCL_SIM_STOREX_EXECUTOR_H
...
class StoreXExecutor : public CcuExecutorBase {
  public:
    explicit StoreXExecutor(int streamId, int rankId, int dieId,
...
#endif // HCCL_SIM_STOREX_EXECUTOR_H

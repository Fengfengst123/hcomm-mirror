...
class DeviceResourceManager {
  public:
    ...
    void NotifyRecord(uint32_t rankId, uint32_t streamId, uint32_t notifyId,
                      uint32_t notifyCnt);
    bool NotifyWait(uint32_t rankId, uint32_t streamId, uint32_t notifyId,
                    uint32_t notifyCnt);
    bool CheckNotifyWait(uint32_t rankId, uint32_t streamId, uint32_t notifyId,
                         uint32_t notifyCnt);

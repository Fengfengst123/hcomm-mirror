...
/**
 * AN "AS IS" BASIS, WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED,
 * for the full text of the License. Description: data type header file Author:
 * zhangqingwei Create: 2024-02-04
 */
...
namespace HcclSim {
MAKE_ENUM(DataType, INT8, INT16, INT32, FP16, FP32, INT64, UINT64, UINT8,
          UINT16, UINT32, FP64, BFP16, INT128, BF16_SAT, HIF8, FP8E4M3, FP8E5M2,
          FP8E8M0);
...
const std::map<uint32_t, std::string> DATA_TYPE_TO_STRING_MAP = {
    ...
    {3, "FP16"}, {4, "FP32"},  {5, "INT64"}};

const std::map<uint32_t, std::string> OP_TYPE_TO_STRING_MAP = {
    {0, "sum"}, {1, "mul"}, {2, "max"}, {3, "PROD"}};
} // namespace HcclSim

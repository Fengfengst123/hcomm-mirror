...
// 转换指令的函数指针
using TransformInstrFunc = HcclResult (*)(const CcuRep::CcuInstr *,
                                          CcuGraphStateV3 *, uint32_t, bool &,
                                          void *);
...
class InstructMapBase {
  public:
    ...
    // 指令转换函数
    virtual HcclResult Transform(const CcuRep::CcuInstr *instr,
                                 CcuGraphStateV3 *task, uint32_t deviceId,
...
class InstructMapA5 : public InstructMapBase {
  public:
    ...
    // 指令转换函数
    HcclResult Transform(const CcuRep::CcuInstr *instr,
                         CcuGraphStateV3 *curCcuTask, uint32_t queId,

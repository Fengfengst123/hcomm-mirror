...
class ValidationIssueRecorder {
  public:
    ...
    ValidationIssueRecorder &
    operator=(const ValidationIssueRecorder &) = delete;

    void Reset();
    void RecordIssue(const std::string &severity, const std::string &stage,
                     const std::string &code, const nlohmann::json &detail);

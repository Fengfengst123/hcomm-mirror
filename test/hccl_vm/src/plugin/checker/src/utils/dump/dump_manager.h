...
class DumpManager {
  public:
    ...
    HcclResult Write(const std::string &relativePath,
                     const nlohmann::json &document) const;
    HcclResult WriteJson(const std::string &relativePath,
                         const nlohmann::json &document) const;
    HcclResult WriteMsgpackStream(
  ...
  private:
    ...
    HcclResult WriteMsgpackFile(const std::string &dumpRootDir,
                                const std::string &relativePath,
                                const nlohmann::json &document) const;
    HcclResult WriteJsonFile(const std::string &dumpRootDir,
                             const std::string &relativePath,
                             const nlohmann::json &document) const;

...
void ClusterTopoDumper::DumpToFile(const Network &network,
...
void ClusterTopoDumper::DumpNetwork(const Network &network, std::ostream &os,
                                    int indent) {
    ...
    os << Indent(indent + 1) << "superPodCount: " << network.GetSuperPodCount()
       << "\n";
    os << Indent(indent + 1)
       << "totalDeviceCount: " << network.GetTotalDeviceCount() << "\n";
    os << Indent(indent + 1)
       << "totalLinkCount: " << network.GetTotalLinkCount() << "\n";
    os << "\n";
...
void ClusterTopoDumper::DumpSuperPod(const SuperPod &superpod, std::ostream &os,
                                     int indent) {
    ...
    os << Indent(indent + 1) << "serverCount: " << superpod.GetServerCount()
       << "\n";
    os << Indent(indent + 1)
       << "totalDeviceCount: " << superpod.GetTotalDeviceCount() << "\n";
    os << "\n";
...
void ClusterTopoDumper::DumpServer(const Server &server, std::ostream &os,
                                   int indent) {
...
void ClusterTopoDumper::DumpDevice(const Device &device, std::ostream &os,
                                   int indent) {
...
void ClusterTopoDumper::DumpPort(const Port &port, std::ostream &os,
                                 int indent) {
...
void ClusterTopoDumper::DumpLink(const Link &link, std::ostream &os,
                                 int indent) {
...
void ClusterTopoDumper::DumpLinkPortRef(const LinkPortRef &ref,
